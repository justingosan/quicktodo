...
// initProjectCmd represents the initialize-project command
var initProjectCmd = &cobra.Command{
	Use:     "initialize-project [project_name]",
	Aliases: []string{"init-project"},
	Short:   "Register current directory as a project",
	Long: `Register the current directory as a QuickTodo project. 

This command creates a new project entry in the registry and initializes
the project database. If no project name is provided, it will use the 
current directory name.

Examples:
  quicktodo initialize-project myproject
  quicktodo init-project
  quicktodo initialize-project "My Amazing Project"`,
